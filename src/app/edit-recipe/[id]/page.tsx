...
import { updateRecipe, getRecipeById } from '@/services/recipe.service';
...
export default function EditRecipePage() {
    ...
    const { register, control, handleSubmit, reset, watch, setValue, formState: { errors } } = useForm<EditRecipeForm>({
        defaultValues: {
    ...
    const { fields, append, remove } = useFieldArray<EditRecipeForm>({
        control,
        name: "ingredients"
    });
    ...
    const onSubmit = async (data: EditRecipeForm) => {
        try {
            setLoading(true);
            setError('');
